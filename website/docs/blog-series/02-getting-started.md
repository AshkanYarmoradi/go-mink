---
id: getting-started
title: "Part 2: Getting Started with go-mink"
sidebar_position: 2
---
...
- `OrderPlaced` -- correct
- `PaymentReceived` -- correct
- `UserRegistered` -- correct
- `OrderUpdate` -- incorrect (vague, present tense)
- `SetStatus` -- incorrect (sounds like a command)
...
[<-- Part 1: Introduction](/docs/blog-series/introduction) | [Part 3: Aggregates -->](/docs/blog-series/aggregates)
