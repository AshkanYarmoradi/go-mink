...
- *Alternative:* require callers to keep their own subject→streams map — rejected (every consumer re-implements the GDPR-critical, easy-to-get-wrong part; the huisscan ops-panel hit exactly this and could not ship a complete export).
